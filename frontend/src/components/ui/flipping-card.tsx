...
export function FlippingCard({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "relative rounded-xl border border-neutral-200/70 bg-white shadow-lg transition-all duration-700 [transform-style:preserve-3d] group-hover/flipping-card:[transform:rotateY(180deg)] dark:border-neutral-800/70 dark:bg-neutral-950",
